...
To change the travel time limit, drag the slider in the left panel. As you adjust the slider, the cards below it will show the number of opportunities (e.g. jobs or workers) that can be reached from your selected origin within your selected travel time limit.
