...
When you have configured all of these options, the green **Regional analysis** <FaPlus /> button in your settings menu will be enabled. Clicking this will prompt you for a name for the analysis and begin processing. 
