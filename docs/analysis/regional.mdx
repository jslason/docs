...
When you have configured all of these options, <Button variantColor='green'><FaPlus /> Regional analysis</Button> in your settings menu will be enabled. Clicking this will prompt you for a name for the analysis and begin processing. 

<Image 
  src='/img/ready-for-regional-analysis.png' 
  alt='With all settings properly configured, we are ready to begin a regional analysis.'
/>
...
<Image
  ...
  alt='Map showing comparison of two regional analyses in Toronto'
/>
...
<Image
  src='/img/seattle-comparison.jpeg'
