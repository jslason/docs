...
* <Button variantColor='yellow'><FaPencilAlt /> Edit dataset name</Button>
* <Button variantColor='red'><FaTrash /> Delete this dataset</Button>
* <Button variantColor='red'><FaTrash /> Delete entire dataset source</Button> (e.g. all attributes from a shapefile)
